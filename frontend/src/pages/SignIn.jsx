  ...
  return (
    <div className='min-h-screen w-full flex items-center justify-center p-4 bg-amber-50'>
        <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8 border border-[#ddd]'>
            ...
            <p className='text-gray-600 mb-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, reiciendis.</p>
           ...
           <div className='text-right mb-4 text-red-500' onClick={()=>navigate("/forgot-password")}>Forgot password</div>


          


            <button className='w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2 transition duration-200 bg-red-500 hover:bg-red-400 cursor-pointer text-white' onClick={handleSignIn} disabled={loading}>{loading?<ClipLoader/>:"Sign In"}</button>
            ...
            <span>Sign In with Google</span>
               ...
               <p className='items-center mt-3 px-6 cursor-pointer'onClick={()=>navigate("/signup")}>want to create a new account?<span className='text-red-500'>Sign In</span></p>
            </div>
